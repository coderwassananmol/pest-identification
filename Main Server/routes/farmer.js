...
router.post('/detectpest', function(req, res, next){
  ...
  model.getRegionByStateName(state, function(err, region){
    model.questionnaire(crop, soil, season, affectedArea, holesAt, discoloration, region, function(err,pests){
      console.log(pests);
    })
  })
...
router.post('/feedback', function(req,res){
  ...
  let mailOptions = {
    ...
    html: "The details of the person are<br><b>Fullname: </b>" + fullname + "<br><b>Season: </b>" + season + "<br><b>State: </b>" + state + "<br><b>Soil: </b>" + soil + "<br><b>Crop: </b>" + crop + "<br><b>Pest: </b>" + pest + "<br><b>Email: </b>" + email + "<br><b>Phone: </b>" + phone + "<br><b>Description: </b>" + desc
  };
...
router.post('/associatewithus', function(req,res){
  ...
  let mailOptions1 = {
    ...
    text: "", // plain text body
    html: "We have recieved a request from you to be associated with us. We will contact you in 24 hours<b>With love,<br> Seheyogi</b>" // html body
  };
  ...
  let mailOptionsICAR = {
    ...
    text: "", // plain text body
    html: "The details of the person are<br><b>Name: </b>" + name + "<br><b>E-mail: </b>" + email + "<br><b>Contact Info: </b>" + contact + "<br><b>Profession: </b>" + check3
  };
